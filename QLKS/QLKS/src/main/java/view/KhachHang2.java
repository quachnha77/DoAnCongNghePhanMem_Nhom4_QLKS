...
public class KhachHang2 extends javax.swing.JPanel {
    DefaultTableModel tableModel;
    int selectindex = -1;
    
   
    public KhachHang2() throws SQLException {
        initComponents();
        showAll();
    }
    ...
    private void jbtHuyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtHuyActionPerformed
        ...
        try {
            ...
            Logger.getLogger(KhachHang2.class.getName()).log(Level.SEVERE, null, ex);
        }
            Reset();

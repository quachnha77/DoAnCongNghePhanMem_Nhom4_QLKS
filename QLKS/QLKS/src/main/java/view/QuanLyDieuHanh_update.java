...
public class QuanLyDieuHanh_update extends javax.swing.JPanel {
    DefaultTableModel tableModel;
    DefaultTableModel tableModel1;
    public QuanLyDieuHanh_update() throws SQLException {
        initComponents();
        showAll();
        showAll1();
    }
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel7Layout.createSequentialGroup()
                        ...
                        .addGap(48, 48, 48)
                        .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jtfDiachi, javax.swing.GroupLayout.DEFAULT_SIZE, 360, Short.MAX_VALUE)
                            .addComponent(jtfSDT))))
                .addGap(52, 52, 52)
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel7Layout.createSequentialGroup()
    ...
    private void kiemtrathem(){
        ...
        }else if(jtfCCCD.getText().equals("")){
            JOptionPane.showMessageDialog(this, "Thiếu thông tin!");
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        try {
            ...
            nv.setMaNV(0);
            if(!jtfHoten.getText().equals("")){nv.setHoTen(jtfHoten.getText());}
                else{JOptionPane.showMessageDialog(this, "Thiếu thông tin!");}
            if(!jtfCCCD.getText().equals("")){nv.setCCCD(jtfCCCD.getText());}
                else{JOptionPane.showMessageDialog(this, "Thiếu thông tin!");}
            if(!jtfDiachi.getText().equals("")){nv.setDiaChi(jtfDiachi.getText());}
                else{JOptionPane.showMessageDialog(this, "Thiếu thông tin!");}
            if(!jtfSDT.getText().equals("")){nv.setSoDienThoai(jtfSDT.getText());}
                else{JOptionPane.showMessageDialog(this, "Thiếu thông tin!");}
            ...
            if(kiemTra(jtfCCCD.getText())){
                ...
                tk.setMatKhau(BCrypt.hashpw("123",BCrypt.gensalt(12)));
    ...
    private void btnLuuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLuuActionPerformed
        ...
        if (n == -1) {
            ...
            try {
                ...
                Logger.getLogger(QuanLyDieuHanh_update.class.getName()).log(Level.SEVERE, null, ex);
            }
